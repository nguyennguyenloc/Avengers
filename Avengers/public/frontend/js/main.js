...
// Sidebar Mini 
// gán biến cho nút click vào để show nút dark theme 
// querySelector: dung cho cả class, id
var toggleBtn = document.querySelector('.sidebarMini__Button');
//thẻ div lớn cho miniSidebar
var sidebarMini = document.querySelector('.sidebarMini');
// công tắc nút on off
var switchBtn = document.querySelector('#checkbox');

// sự kiện sidebar button
toggleBtn.addEventListener('click', function () {
    // sự kiện: click rồi thực hiện chức năng function
    // hàm addClass: chưa có class thì add class vào, còn có rồi thì click vào class đó mất
    // classList: thêm class mới vào
    // toggle: như công tắc, nếu có 'is-opened' thì xoá nó, chưa có thì add 'is-opened' vào
    sidebarMini.classList.toggle('is-opened')
});

switchBtn.addEventListener('click', function () {
    // cần thêm class vào thẻ body
